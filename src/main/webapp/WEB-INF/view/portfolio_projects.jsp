					...
					<div class="well well-sm">
						...
						<p>
							...
							<ul>
								...
								<li>IA, Wind & physics</li>
								<li>Level editor</li>
								<li>Themes availables</li>
							</ul>
						</p>
						<span class="label label-primary">GAME</span> <span class="label label-success">JAVA</span>
					</div>
				</div>
			</div>
			<div class="row text-left">
			...
			<div class="row text-left">
				<div class="col-sm-12">
					<div class="well well-sm">
						...
						<span class="label label-primary">APPLICATION</span> <span class="label label-success">JAVA</span>
					</div>
				</div>
			</div>
			<div class="row text-left">
				<div class="col-sm-12">
					<div class="well well-sm">
						...
						<p>
							...
							<ul>
								<li>Breakout game like</li>
								<li>Several speeds and forms available</li>
							</ul>
						</p>
						<span class="label label-primary">GAME</span> <span class="label label-success">JAVA</span>
					</div>
				...
				<div class="col-sm-12">
					<div class="well well-sm">
						...
						<p>
							...
							<ul>
								<li>Implemented with rules</li>
								<li>Console display with issues</li>
							</ul>
						</p>
						<span class="label label-primary">APPLICATION</span> <span class="label label-success">C</span>
					</div>
				</div>
			</div>
			<div class="row text-left">
				<div class="col-sm-12">
					<div class="well well-sm">
						...
						<p>
							...
							<ul>
								<li>Use unique key to encrypt</li>
								<li>Two parts: Encrypt or Decrypt</li>
							</ul>
						</p>
						<span class="label label-primary">APPLICATION</span> <span class="label label-success">JAVA</span>
					</div>
